...
def preprocess_and_crop(input_folder, output_folder_prepro, output_folder_crop):
    ...
    for filename in os.listdir(input_folder):
        if filename.endswith(('.png', '.jpg', '.jpeg','.JPG')):
            ...
            cv2.imwrite(preprocessed_filename, no_noise)
            ...
            #date = 420:485, 320:600
            #time = 420:485, 630:745
            #owner = 665:775, 200:1080
            y_start, y_end, x_start, x_end = 420,485, 320,600
            cropped_img = no_noise[y_start:y_end, x_start:x_end]
...
output_folder_prepro = "testpytesseract\\dataset\\scb\\preprocessed\\"
output_folder_crop = "testpytesseract\\dataset\\scb\\section\\crop\\date\\"
